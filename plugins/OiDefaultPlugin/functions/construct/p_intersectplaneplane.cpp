 ...
 * \return
 */
PluginMetaData* IntersectPlanePlane::getMetaData() const{
 ...
 * \return
 */
QList<InputParams> IntersectPlanePlane::getNeededElements() const{
 ...
 * \return
 */
QList<Configuration::FeatureTypes> IntersectPlanePlane::applicableFor() const{
