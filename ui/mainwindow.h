...
private slots:
    ...
    void treeViewFeaturesSelectionChangedbyKeyboard(const QModelIndex &selected, const QModelIndex &deselected);
    void on_treeView_features_clicked(const QModelIndex &index);
