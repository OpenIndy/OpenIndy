...
void EditTrafoparamDialog::initGUI()
{
    ...
    ui->lineEdit_scaleX->setText(QString::number(this->selectedTrafoParam->getTrafoParam()->scale.getAt(0),'f',6));
    ui->lineEdit_scaleY->setText(QString::number(this->selectedTrafoParam->getTrafoParam()->scale.getAt(1),'f',6));
    ui->lineEdit_scaleZ->setText(QString::number(this->selectedTrafoParam->getTrafoParam()->scale.getAt(2),'f',6));
