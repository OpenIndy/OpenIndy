...
/*!
 * \brief MultiSelectionModel::MultiSelectionModel
 * \param myModel
 */
MultiSelectionModel::MultiSelectionModel(QAbstractItemModel *myModel) : QItemSelectionModel(myModel)
{
}

MultiSelectionModel::~MultiSelectionModel()
{

}

/*!
 * \brief MultiSelectionModel::select
...
/*!
 * \brief MultiSelectionModel::checkIndex
 * Checks wether one of the parents of index is selected or gets selected, too. Returns true if no parent gets selected
 * \param index
 * \param selection
 * \return
 */
bool MultiSelectionModel::checkIndex(const QModelIndex &index, const QItemSelection &selection){
