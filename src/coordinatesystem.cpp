...
QDomElement CoordinateSystem::toOpenIndyXML(QDomDocument &xmlDoc){
    ...
    QDomElement xAxis = xmlDoc.createElement("coordinates");
    ...
    QDomElement yAxis = xmlDoc.createElement("coordinates");
    ...
    QDomElement zAxis = xmlDoc.createElement("coordinates");
