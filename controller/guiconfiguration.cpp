...
void GUIConfiguration::generateAllAttributes()
{
    ...
    GUIConfiguration::allAttributes.append(QString("x" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("y" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("z" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("stddev" + OiUnitConverter::getMetricUnitTypeName()));
    ...
    GUIConfiguration::allAttributes.append(QString("radius" + OiUnitConverter::getMetricUnitTypeName()));
    ...
    GUIConfiguration::allAttributes.append(QString("temperature" + OiUnitConverter::getTemperatureUnitTypeName()));
    GUIConfiguration::allAttributes.append("measurement series");
    GUIConfiguration::allAttributes.append(QString("expansion origin x" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("expansion origin y" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("expansion origin z" + OiUnitConverter::getMetricUnitTypeName()));
    ...
    GUIConfiguration::allAttributes.append(QString("translation x" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("translation y" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("translation z" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("rotation x" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("rotation y" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allAttributes.append(QString("rotation z" + OiUnitConverter::getAngularUnitTypeName()));
...
void GUIConfiguration::generateFeatureAttributes()
{
    ...
    DisplayAttribute *fX = new DisplayAttribute(QString("x"+OiUnitConverter::getMetricUnitTypeName()),true);
    GUIConfiguration::featureAttributes.append(fX);
    DisplayAttribute *fY = new DisplayAttribute(QString("y"+OiUnitConverter::getMetricUnitTypeName()),true);
    GUIConfiguration::featureAttributes.append(fY);
    DisplayAttribute *fZ = new DisplayAttribute(QString("z"+OiUnitConverter::getMetricUnitTypeName()),true);
    GUIConfiguration::featureAttributes.append(fZ);
    DisplayAttribute *fStddev = new DisplayAttribute(QString("stddev"+OiUnitConverter::getMetricUnitTypeName()),true);
    ...
    DisplayAttribute *fRadius = new DisplayAttribute(QString("radius"+OiUnitConverter::getMetricUnitTypeName()),true);
    ...
    DisplayAttribute *fTemperature = new DisplayAttribute(QString("temperature"+OiUnitConverter::getTemperatureUnitTypeName()),false);
    ...
    DisplayAttribute *fExpOriX = new DisplayAttribute(QString("expansion origin x" + OiUnitConverter::getMetricUnitTypeName()),false);
    GUIConfiguration::featureAttributes.append(fExpOriX);
    DisplayAttribute *fExpOriY = new DisplayAttribute(QString("expansion origin y" + OiUnitConverter::getMetricUnitTypeName()),false);
    GUIConfiguration::featureAttributes.append(fExpOriY);
    DisplayAttribute *fExpOriZ = new DisplayAttribute(QString("expansion origin z" + OiUnitConverter::getMetricUnitTypeName()),false);
...
void GUIConfiguration::generateTrafoParamAttributes()
{
    ...
    DisplayAttribute *fSTD = new DisplayAttribute(QString("stddev" + OiUnitConverter::getMetricUnitTypeName()),true);
    ...
    DisplayAttribute *fTranslationX = new DisplayAttribute(QString("translation x"+OiUnitConverter::getMetricUnitTypeName()),true);
    GUIConfiguration::trafoParamAttributes.append(fTranslationX);
    DisplayAttribute *fTranslationY = new DisplayAttribute(QString("translation y"+OiUnitConverter::getMetricUnitTypeName()),true);
    GUIConfiguration::trafoParamAttributes.append(fTranslationY);
    DisplayAttribute *fTranslationZ = new DisplayAttribute(QString("translation z"+OiUnitConverter::getMetricUnitTypeName()),true);
    GUIConfiguration::trafoParamAttributes.append(fTranslationZ);
    DisplayAttribute *fRotationX = new DisplayAttribute(QString("rotation x"+OiUnitConverter::getAngularUnitTypeName()),true);
    GUIConfiguration::trafoParamAttributes.append(fRotationX);
    DisplayAttribute *fRotationY = new DisplayAttribute(QString("rotation y"+OiUnitConverter::getAngularUnitTypeName()),true);
    GUIConfiguration::trafoParamAttributes.append(fRotationY);
    DisplayAttribute *fRotationZ = new DisplayAttribute(QString("rotation z"+OiUnitConverter::getAngularUnitTypeName()),true);
...
void GUIConfiguration::generateAllReadAttr()
{
    ...
    GUIConfiguration::allReadAttributes.append(QString("azimuth" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("zenith" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("distance" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("sigma azimuth" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("sigma zenith" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("sigma distance" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("x" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("y" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("z" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("sigma x" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("sigma y" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("sigma z" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allReadAttributes.append("front sight");
    GUIConfiguration::allReadAttributes.append(QString("temperature" + OiUnitConverter::getTemperatureUnitTypeName()));
    GUIConfiguration::allReadAttributes.append("valid");
    GUIConfiguration::allReadAttributes.append(QString("sigma temperature" + OiUnitConverter::getTemperatureUnitTypeName()));
    ...
    GUIConfiguration::allReadAttributes.append(QString("RX" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("RY" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("RZ" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("sigma RX" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("sigma RY" + OiUnitConverter::getAngularUnitTypeName()));
    GUIConfiguration::allReadAttributes.append(QString("sigma RZ" + OiUnitConverter::getAngularUnitTypeName()));
}
...
void GUIConfiguration::generatePolarAttr()
{
    ...
    DisplayAttribute *readAzimuth = new DisplayAttribute(QString("azimuth" + OiUnitConverter::getAngularUnitTypeName()),true);
    DisplayAttribute *readZenith = new DisplayAttribute(QString("zenith" + OiUnitConverter::getAngularUnitTypeName()),true);
    DisplayAttribute *readDistance = new DisplayAttribute(QString("distance" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *readSigAz = new DisplayAttribute(QString("sigma azimuth" + OiUnitConverter::getAngularUnitTypeName()),true);
    DisplayAttribute *readSigZe = new DisplayAttribute(QString("sigma zenith" + OiUnitConverter::getAngularUnitTypeName()),true);
    DisplayAttribute *readSigDist = new DisplayAttribute(QString("sigma distance" + OiUnitConverter::getMetricUnitTypeName()),true);
...
void GUIConfiguration::generateCartAttr()
{
    ...
    DisplayAttribute *readTime = new DisplayAttribute("time",true);
    DisplayAttribute *readInstrument = new DisplayAttribute("instrument",true);
    DisplayAttribute *readX = new DisplayAttribute(QString("x" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *readY = new DisplayAttribute(QString("y" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *readZ = new DisplayAttribute(QString("z" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *readSigX = new DisplayAttribute(QString("sigma x" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *readSigY = new DisplayAttribute(QString("sigma y" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *readSigZ = new DisplayAttribute(QString("sigma z" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *readValid = new DisplayAttribute("valid",true);
    DisplayAttribute *readFSBS = new DisplayAttribute("front sight",true);
...
void GUIConfiguration::generateDistAttr()
{
    ...
    DisplayAttribute *readTime = new DisplayAttribute("time",true);
    DisplayAttribute *readInstrument = new DisplayAttribute("instrument",true);
    DisplayAttribute *readDist = new DisplayAttribute(QString("distance" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *readSigDist = new DisplayAttribute(QString("sigma distance" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *readValid = new DisplayAttribute("valid",true);
    DisplayAttribute *readFSBS = new DisplayAttribute("front sight",true);
...
void GUIConfiguration::generateTempAttr()
{
    ...
    DisplayAttribute *readTime = new DisplayAttribute("time",true);
    DisplayAttribute *readInstrument = new DisplayAttribute("instrument",true);
    DisplayAttribute *readTemp = new DisplayAttribute(QString("temperature" + OiUnitConverter::getTemperatureUnitTypeName()),true);
    DisplayAttribute *readValid = new DisplayAttribute("valid",true);
    DisplayAttribute *readSigTemp = new DisplayAttribute(QString("sigma temperature" + OiUnitConverter::getTemperatureUnitTypeName()),true);
...
void GUIConfiguration::generateLevelAttr()
{
    ...
    DisplayAttribute *readInstrument = new DisplayAttribute("instrument",true);
    DisplayAttribute *readValid = new DisplayAttribute("valid",true);
    DisplayAttribute *readRX = new DisplayAttribute(QString("RX" + OiUnitConverter::getAngularUnitTypeName()),true);
    DisplayAttribute *readRY = new DisplayAttribute(QString("RY" + OiUnitConverter::getAngularUnitTypeName()),true);
    DisplayAttribute *readRZ = new DisplayAttribute(QString("RZ" + OiUnitConverter::getAngularUnitTypeName()),true);
    DisplayAttribute *readSigRX = new DisplayAttribute(QString("sigma RX" + OiUnitConverter::getAngularUnitTypeName()),true);
    DisplayAttribute *readSigRY = new DisplayAttribute(QString("sigma RY" + OiUnitConverter::getAngularUnitTypeName()),true);
    DisplayAttribute *readSigRZ = new DisplayAttribute(QString("sigma RZ" + OiUnitConverter::getAngularUnitTypeName()),true);
...
void GUIConfiguration::generateAllObsAttributes()
{
    ...
    GUIConfiguration::allObsAttributes.append(QString("x" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allObsAttributes.append(QString("y" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allObsAttributes.append(QString("z" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allObsAttributes.append("valid");
    GUIConfiguration::allObsAttributes.append(QString("sigma x" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allObsAttributes.append(QString("sigma y" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allObsAttributes.append(QString("sigma z" + OiUnitConverter::getMetricUnitTypeName()));
    GUIConfiguration::allObsAttributes.append("solved");
    GUIConfiguration::allObsAttributes.append("use");
}
...
void GUIConfiguration::generateObsAttributes()
{
    ...
    DisplayAttribute *obsX = new DisplayAttribute(QString("x" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *obsY = new DisplayAttribute(QString("y" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *obsZ = new DisplayAttribute(QString("z" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *obsValid = new DisplayAttribute("valid",true);
    DisplayAttribute *obsSX = new DisplayAttribute(QString("sigma x" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *obsSY = new DisplayAttribute(QString("sigma y" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *obsSZ = new DisplayAttribute(QString("sigma z" + OiUnitConverter::getMetricUnitTypeName()),true);
    DisplayAttribute *obsSolved = new DisplayAttribute("solved",true);
    DisplayAttribute *obsUse = new DisplayAttribute("use",true);
    ...
    GUIConfiguration::obsAttributes.append(obsUse);
}
